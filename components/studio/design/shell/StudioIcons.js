...
// ---- Clean 6B — Studio Flow Clarity (additive) ----

// Work tray — breadcrumb escape to מגש עבודה.
export const TrayNavIcon = (p) => (
  <Icon {...p}>
    <path d="M4 7h16l-2 12a2 2 0 01-2 2H8a2 2 0 01-2-2L4 7z" />
    <path d="M8 7V6a4 4 0 018 0v1" />
  </Icon>
);

// Grid of directions — "חזרה לכיוונים" / show all.
...
// Small gem — stone-usage section marker.
export const GemIcon = (p) => (
  <Icon {...p}>
    <path d="M7 4h10l4 5-9 11L3 9l4-5z" />
    <path d="M3 9h18M12 20L8.5 9M12 20L15.5 9" />
  </Icon>
);
...
// Note lines — free-text section marker.
