...
const styles = {
  ...
  wizardBtn: { minHeight: '44px', padding: '10px 20px', fontFamily: tokens.font.body, fontSize: '14px', fontWeight: 700, color: tokens.color.ivory, background: tokens.color.charcoal, border: 'none', borderRadius: tokens.radius.md, cursor: 'pointer', boxShadow: tokens.shadow.soft },
  ...
  title: { fontFamily: tokens.font.display, fontWeight: 700, fontSize: '26px', color: tokens.color.charcoal, margin: '6px 0 8px' },
