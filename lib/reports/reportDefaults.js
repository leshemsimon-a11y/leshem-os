/**
 * lib/reports/reportDefaults.js  —  v5.4.3
 *
 * Changes from v5.4.2:
 *
...
export function buildStoneClassification(item) {
  ...
  switch (pt) {
    case "natural_diamond":
      out.productCategory = "Natural Diamond";
      break;
    case "lab_grown_diamond":
    ...
    case "stone_pair_set":
      ...
      break;
    case "stone_parcel":
      out.productCategory = "Stone Parcel";
      break;
    case "jewelry_part":
  ...
  // ── intendedUse — ONLY cert-safe professional values ─────────────────────
  // Never show commercial/internal values like "Sale", "Assembly", "Display"
