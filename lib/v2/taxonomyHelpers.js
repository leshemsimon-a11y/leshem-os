...
const SHAPE_LABELS = {
  ...
  emerald:  { he: 'אמרלד', en: 'Emerald Cut' },
  cushion:  { he: 'קושן', en: 'Cushion' },
  radiant:  { he: 'רדיאנט', en: 'Radiant' },
  pear:     { he: 'טיפה', en: 'Pear' },
  marquise: { he: 'מרקיזה', en: 'Marquise' },
  princess: { he: 'פרינסס', en: 'Princess' },
  heart:    { he: 'לב', en: 'Heart' },
  asscher:  { he: 'אשר', en: 'Asscher' },
  trillion: { he: 'טריליון', en: 'Trillion' },
  baguette: { he: 'בגט', en: 'Baguette' },
  other:    { he: 'אחר', en: 'Other' },
};
...
export const FIELD_MAP = {
  ...
  assetType: ['סוג פריט', 'Asset Type', 'assetType', 'type', 'Type', 'itemType'],
  stoneCategory: ['קטגוריית אבן', 'Stone Category', 'stoneCategory', 'productTypeKey'],
  origin: ['מקור / גידול', 'מקור גידול', 'Natural / Lab-Grown', 'Origin / Growth', 'מקור', 'origin', 'Origin', 'growthMethod'],
  stoneType: ['סוג אבן', 'Stone Type', 'stoneType', 'stoneTypeKey'],
  shape: ['צורה \\ ליטוש', 'צורה / ליטוש', 'צורה', 'Shape', 'shape', 'stoneShape'],
  cutForm: ['Cut / Form', 'cutForm', 'cutFormKey'],
  ...
  stoneCount: ['מספר אבנים', 'Stone Count', 'Quantity', 'quantity', 'stoneCount'],
  color: ['צבע', 'צבע ', 'Colour', 'Color', 'color'],
  clarity: ['ניקיון', 'Clarity', 'clarity'],
  cut: ['Cut Grade', 'קאט', 'cut', 'Cut', 'cutGrade'],
  ...
  measurements: ['מידות', 'Measurements', 'measurements', 'measurementsRaw'],
  depthPercent: ['Depth %', 'עומק אחוז', 'depthPercent'],
  tablePercent: ['Table %', 'שולחן אחוז', 'tablePercent'],
  labName: ['מקור תעודה', 'מעבדה', 'Lab', 'Lab Name', 'labName', 'certLab'],
  reportNumber: ['מספר תעודה', 'חריטת לייזר', 'Report Number', 'Certificate Number', 'reportNumber', 'laserInscription', 'verificationId', 'memoNumber'],
  inventoryLayer: ['שכבת מלאי', 'Inventory Layer', 'inventoryLayer', 'inventoryLayerKey'],
  status: ['סטטוס מלאי', 'סטטוס', 'Status', 'status', 'inventoryStatus'],
  internalNotes: ['Internal Notes', 'הערות פנימיות', 'internalNotes'],
  costPrice: ['עלות בדולר', 'מחיר עלות', 'Cost Price', 'costPrice', 'costUsd'],
  askingPrice: ['מחיר מבוקש', 'Asking Price', 'askingPrice'],
  supplierName: ['שם ספק', 'ספק וירטואלי', 'Supplier', 'supplierName', 'virtualSupplier'],
  imageUrl: ['תמונה לתעודה', 'תמונות \\ וידאו מלאי', 'תמונה', 'Image', 'Photo', 'imageUrl', 'thumbnailUrl', 'imageUrlText', 'certImageUrl'],
  ...
  title: ['תיאור פריט', 'שם', 'Title', 'Name', 'title', 'name'],
