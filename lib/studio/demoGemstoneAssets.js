...
const GEMSTONE_KEYWORD_MAP = [
  ...
  [/אזמרגד.*(כרית|קושן)|(כרית|קושן).*אזמרגד|cushion.*emerald/, { variety: 'Emerald', shape: 'Cushion' }],
  ...
  [/פראיבה|פאראיבה|טורמלין|paraiba|tourmaline/, { variety: 'Paraiba Tourmaline', shape: 'Oval' }],
  [/כרית|קושן|cushion/, { variety: 'White Diamond', shape: 'Cushion' }],
  [/אגס|טיפה|pear/, { variety: 'White Diamond', shape: 'Pear' }],
...
export function getDemoActivityFeed() {
  return Object.freeze([
    ...
    { id: 'demo-act-2', textHe: 'רובי קושן נשלח למגש העבודה', tone: 'tray' },
