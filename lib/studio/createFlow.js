...
export const CREATE_PRODUCT_OPTIONS = Object.freeze([
  { key: 'ring', he: 'טבעת' },
  { key: 'engagementRing', he: 'טבעת אירוסין' },
  { key: 'weddingBand', he: 'טבעת נישואים' },
  { key: 'pendant', he: 'תליון' },
  { key: 'earrings', he: 'עגילים' },
  { key: 'bracelet', he: 'צמיד' },
  { key: 'necklace', he: 'שרשרת' },
  { key: 'matchingPiece', he: 'תכשיט משלים' },
  { key: 'noStones', he: 'תכשיט ללא אבנים' },
...
export const CREATE_STYLE_OPTIONS = Object.freeze([
  ...
  { key: 'statement', he: 'נוכח' },
  { key: 'vintage', he: 'וינטג׳' },
  { key: 'cluster', he: 'קלאסטר' },
  { key: 'minimal', he: 'מינימליסטי' },
  { key: 'halo', he: 'הילה' },
  { key: 'solitaire', he: 'סוליטר' },
  { key: 'threeStone', he: 'שלוש אבנים' },
  { key: 'tennis', he: 'טניס' },
...
const PRODUCT_EN = Object.freeze({
  ...
  noStones: 'metal-only jewelry piece',
