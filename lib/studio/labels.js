...
export const SNAPSHOT_HE = Object.freeze({
  ...
  status: Object.freeze({
    ...
    draftBody: 'יש אבן מרכזית — אפשר להוסיף סוג תכשיט ותפריט עיצוב לתקציר.',
  }),
});
...
export const INTENT_HE = Object.freeze({
  ...
  drawerTitle: 'תפריט עיצוב',
  openIntent: 'תפריט עיצוב',
  summaryEmpty: 'פתח תפריט עיצוב',
  done: 'סיום',
  close: 'סגירה',
  notDecided: 'לא הוחלט',
