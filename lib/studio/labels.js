...
export const UI_HE = Object.freeze({
  ...
  nav: {
    ...
    // Patch C — OS Hardening V1: the saved project is the core unit of work;
    // the visible nav label is now תיקי עבודה. Key name, routes, stores and
    // storage keys are all UNCHANGED — display value only.
    projects: 'תיקי עבודה',
    assets: 'ספריית נכסים',
    models: 'דגמים',
    render: 'הדמיה',
  ...
  // Patch C — OS Hardening V1 (additive): not-yet-built sections are grouped
  // under one quiet, collapsed area instead of filling the primary nav.
  navFutureTools: 'כלים עתידיים',
  navFutureToolsHint: 'מודולים שייפתחו בשלבים הבאים',
});
...
export const TRAY_HE = Object.freeze({
  ...
  // Clean 5C — primary stone-to-jewelry CTA (used when items are selected).
  createJewelry: 'צור תכשיט מאבנים',
...
export const BRIEF_HE = Object.freeze({
  ...
  style: Object.freeze({
    ...
    minimal: 'מינימליסטי',
    statement: 'נוכח',
    // --- Clean 5E — additive keys for the new STYLE_PREFERENCE values ---
    luxury: 'יוקרתי',
    delicate: 'עדין',
    halo: 'האלו',
    solitaire: 'סוליטר',
    threeStone: 'שלוש אבנים',
    tennis: 'טניס',
    custom: 'מותאם אישית',
  }),
...
export const CONCEPT_HE = Object.freeze({
  ...
  // Clean 6B — terminology: this titles the INPUT form (the user's request),
  // which is Design Intent (כוונת עיצוב), not a generated direction.
  directionTitle: 'כוונת עיצוב',
  designGoalLabel: 'מטרת העיצוב',
  designGoalPlaceholder: 'מה אנחנו רוצים ליצור ולמי…',
  styleDirectionLabel: 'סגנון', // Clean 6B — shorter; reserves 'כיוון' for generated directions
  metalLabel: 'העדפת מתכת',
  ...
  stoneUsage: Object.freeze({
    ...
    // --- Clean 5E — additive key for the new STONE_USAGE value ---
    systemSuggest: 'שהמערכת תציע',
  }),
  ...
  notesLabel: 'הערות',
  notesPlaceholder: 'הערות חופשיות…', // Clean 6B — the note belongs to the intent, not a direction
  ...
  // Clean 5B.3 — per-direction controls + iceberg disclosures (additive).
  refreshConcept: 'רענן כיוון',
  removeConcept: 'הסר כיוון',
  removeConfirmQuestion: 'הסר כיוון?',
  removeConfirmYes: 'אישור',
  removeConfirmNo: 'ביטול',
  conceptDetails: 'פרטי הכיוון',
  moreDirectionFields: 'פרטים נוספים',
  workingWith: 'עם מה עובדים',

  // Clean 5D-R4 — Studio Layout Reset (narrow, approved exception). The full
  // existing direction form (product type, working-with, goal, style/metal/
  // stone-usage chips, more-fields) now nests under this single outer
  // disclosure by default, with a new 3-card quick style pick shown above it.
  // Additive only — no existing key removed.
  advancedDirectionDetails: 'פרטי כיוון מתקדמים',
  quickStyleLabel: 'סגנון',
  toastConceptRemoved: 'הכיוון הוסר',
  toastConceptRefreshed: 'הכיוון רוענן',
...
export const OUTPUT_HE = Object.freeze({
  ...
  // Clean 5C — structured, copy-ready render brief (Hebrew labels, English prompt)
  prepareRenderBrief: 'הכן בריף הדמיה',
  renderBriefReadyTitle: 'בריף הדמיה',
  renderBriefReadyHint: 'בריף מובנה להעתקה לכלי הדמיה (באנגלית — מתאים לכלי AI).',
  renderBriefCopy: 'העתק בריף',
  renderBriefCopied: 'הבריף הועתק ✓',
  renderBriefPromptLabel: 'פרומפט להעתקה',
  renderBriefFields: Object.freeze({
    jewelryType: 'סוג תכשיט',
    stonePlacement: 'אבנים ומיקום',
    metal: 'מתכת',
    settingStyle: 'סגנון שיבוץ',
    proportions: 'פרופורציות',
    cameraAngle: 'זווית צילום',
    lighting: 'תאורה',
    background: 'רקע',
    styleDescriptor: 'סגנון חזותי',
  }),
...
export const FLOW_HE = Object.freeze({
  ...
  // ---- Clean 5B.2 — Compact Pro Studio (additive only) ----
  // Top status bar field labels + compact values. App-facing Hebrew only.
  statusBar: Object.freeze({
    activeWork: 'עבודה פעילה',
    activeWorkNone: 'טיוטה מקומית',
    product: 'מוצר',
    productNone: 'טרם נבחר',
    direction: 'כיוון נבחר',
    directionNone: 'אין כיוון',
    output: 'מצב פלט',
    outputReady: 'מוכן',
    outputStale: 'דורש עדכון',
    outputNone: 'אין פלט',
    nextStep: 'הצעד הבא',
  }),

  // Side / control panel section titles + actions.
  panel: Object.freeze({
    controlTitle: 'בקרת עיצוב',
    workArea: 'אזור העבודה',
    actions: 'פעולות',
    directionSummary: 'כיוון העיצוב',
    stonesSummary: 'אבנים בעבודה',
    saveTitle: 'שמירה לעבודה',
    moreTitle: 'עוד בסטודיו',
    editDirection: 'עריכת כיוון',
    collapse: 'מזער',
    expand: 'הצג',
    openInWork: 'פתח את אזור העבודה',
  }),

  // Flow-level stale banner (always visible, not hidden inside a stage).
  flowStale: Object.freeze({
    conceptsTitle: 'הבחירות השתנו',
    conceptsBody: 'כדאי לעדכן את כיווני העיצוב.',
    conceptsAction: 'עדכן כיווני עיצוב',
    outputTitle: 'הפלט מבוסס על כיוון קודם',
    outputBody: 'כדאי לעדכן את הפלט.',
    outputAction: 'עדכן פלט עיצוב',
  }),
});
// ===========================================================================
...
export const DASH_ACTIONS_HE = Object.freeze({
  ...
  cards: Object.freeze({
    createJewelry: Object.freeze({
      title: 'צור תכשיט מאבנים',
      desc: 'בחרו אבנים והפיקו כיווני עיצוב ובריף הדמיה במהירות.',
      cta: 'צור תכשיט מאבנים',
      glyph: '✦',
    }),
    design: Object.freeze({
...
// ===========================================================================
// Clean 5H — Command Center Dashboard (additive)
//
// Labels for the rebuilt Dashboard's zones: Command Header, Quick Launch
// Strip, Inventory Pulse, Active Work Tray, Design Pipeline, Recent
// Activity, Next Actions. Kept as a separate object from DASH_ACTIONS_HE
// (untouched above) since this is a content rebuild of the Dashboard, not an
// edit to the existing guided-action-card labels.
// ===========================================================================
export const COMMAND_CENTER_HE = Object.freeze({
  statusReady: 'המערכת מוכנה',
  statusActiveWork: 'עבודה פעילה',
  continueWork: 'המשך עבודה',

  quickLaunchTitle: 'פעולות מהירות',
  quickLaunch: Object.freeze({
    newDesign: 'עיצוב חדש',
    inventory: 'מלאי',
    workTray: 'מגש עבודה',
    assets: 'ספריית נכסים',
    design: 'סטודיו עיצוב',
    reports: 'דוחות',
    // Patch C — OS Hardening V1 (additive): saved work sessions entry.
    projects: 'תיקי עבודה',
  }),
  reportsSoon: 'דוחות — בקרוב',

  inventoryPulseTitle: 'דופק מלאי',
  inventoryStat: Object.freeze({
    total: 'סה"כ',
    available: 'זמינות',
    inTray: 'במגש',
    reserved: 'שמורות',
  ...
  activeTrayTitle: 'מגש עבודה פעיל',
  activeTrayEmpty: 'בחר אבנים מהמלאי',
  activeTrayOpen: 'פתח מגש',

  pipelineTitle: 'מסלול עיצוב',
  ...
  activityEmpty: 'אין פעילות עדיין',

  nextActionsTitle: 'לטיפול',
  nextAction: Object.freeze({
    trayStones: 'אבנים במגש',
    pendingConcepts: 'קונספטים לטיפול',
    reportsToComplete: 'דוחות להשלמה',
    assetsNoPhoto: 'נכסים ללא תמונה',
    // Patch C — OS Hardening V1 (additive): saved work sessions count.
    savedSessions: 'תיקי עבודה שמורים',
  }),
  soon: 'בקרוב',

  // Patch C — OS Hardening V1 (additive). Command-header session states —
  // the Command Center is a launch + resume surface, so the header always
  // names the current state and offers one obvious action.
  noActiveSession: 'אין תיק פעיל',
  startFromInventory: 'התחל מהמלאי',
  openStudio: 'פתח סטודיו',
  stonesInTray: (n) => (n === 1 ? 'אבן אחת במגש' : `${n} אבנים במגש`),
  resumeLatest: 'תיק אחרון',
});

// ===========================================================================
// Patch C — OS Hardening V1 (additive): Active Session context bar.
// One compact app-frame strip: where am I, what session is active, how many
// stones are in the tray, and the single next action. Short text only.
// ===========================================================================
export const SESSION_BAR_HE = Object.freeze({
  activeSession: 'תיק עבודה פעיל',
  noActiveSession: 'אין תיק פעיל',
  stonesInTray: (n) => (n === 1 ? 'אבן אחת במגש' : `${n} אבנים במגש`),
  conceptSelected: 'כיוון נבחר',
  sessionSaved: 'תיק שמור',
  continueWork: 'המשך עבודה',
  startFromInventory: 'התחל מהמלאי',
  openStudio: 'פתח סטודיו',
  openTray: 'מגש עבודה',
  ariaBar: 'שורת תיק העבודה הפעיל',
});

// ===========================================================================
// Clean 5D — Visual Studio Shell (additive; app-facing Hebrew)
// ===========================================================================
// Labels for the new workstation chrome: command bar, workflow rail, stone
// strip, canvas, inspector drawer, bottom action strip. Presentation only —
// no field renames, no logic.
export const STUDIO_5D_HE = Object.freeze({
  appName: 'LESHEM.S OS',
  studioTag: 'סטודיו עיצוב',

  // Command bar status
  statusDraft: 'טיוטה מקומית',
  statusActive: 'עבודה פעילה',
  statusOutputReady: 'פלט מוכן',
  statusOutputStale: 'דורש עדכון',
  statusNoOutput: 'אין פלט',

  // Workflow rail (short labels)
  rail: Object.freeze({
    stones: 'אבנים',
    product: 'מוצר',
    design: 'עיצוב',
  ...
  railProductionSoon: 'ייצור — בקרוב',
  exitStudio: 'חזרה למערכת',
  exitShort: 'יציאה',

  // Stone strip
  stonesTitle: 'אבני עבודה',
  stonesEmpty: 'מתכת בלבד',
  stonesMetalOnly: 'מתכת בלבד',
  caratSuffix: 'ct',
  parcelChip: 'פרסל',
  addStones: 'הוסף אבנים',
  canvasRender: 'תצוגה',
  canvasBlueprint: 'סקיצה טכנית',

  // Canvas
  canvasPickDirection: 'בחרו כיוון',
  canvasNoConcepts: 'הפיקו כיווני עיצוב כדי להתחיל',
  canvasSelectedPrefix: 'כיוון נבחר',
  canvasPreviewSoon: 'תצוגת הדמיה — שלב עתידי',
  canvasPreviewBadge: 'בקרוב',
  canvasStarterTitle: 'התחילו לעצב תכשיט',
  canvasStarterStones: 'מוכן לעיצוב',
  canvasSlot: 'כיוון',

  // Inspector drawer
  inspectorTitle: 'מפרט הכיוון',
  inspectorEmpty: 'טרם נבחר כיוון',
  rows: Object.freeze({
    centerStone: 'אבן מרכזית',
    sideStones: 'אבני צד / נוספות',
    metal: 'מתכת',
    setting: 'שיבוץ',
    style: 'סגנון',
    feasibility: 'היתכנות ייצור',
  }),
  sections: Object.freeze({
    designLogic: 'היגיון העיצוב',
    stoneUsage: 'שימוש באבנים',
    materials: 'חומרים',
    production: 'הערות ייצור',
    assumptions: 'הנחות',
    nextSteps: 'צעדים הבאים',
  }),
  openInspector: 'פתח מפרט',
  closeInspector: 'סגור',

  // Bottom strip
  variantsTitle: 'כיווני עיצוב', // Clean 6B — the palette is explicitly the generated design directions
  primaryPrepareBrief: 'הכן בריף הדמיה',
  primaryGenerateConcepts: 'הפק כיווני עיצוב',
  primaryUpdateConcepts: 'עדכן כיוונים',
  primarySelectDirection: 'בחרו כיוון',
  primaryGenerateOutput: 'הפק פלט עיצוב',
  // Clean 5F — Core Flow Polish V1. Shown while still on the direction step,
  // so the CTA never over-promises what a click actually does (the real
  // "generate" action lives on the concepts step). Additive only.
  primaryContinueToConcepts: 'המשך לכיווני עיצוב',

  // Stale (calm, visual) — title is the only always-visible text now; the
  // body strings are kept as tooltip text (title attr) on the banner, per
  // the UX Compression Pass — nothing removed, just relocated.
  staleConceptsTitle: 'הבחירות השתנו',
  staleConceptsBody: 'הכיוונים נוצרו מנתונים קודמים.',
  staleConceptsAction: 'עדכן כיוונים',
  staleOutputTitle: 'דורש עדכון',
  staleOutputBody: 'הפלט נוצר מנתונים קודמים.',
  staleOutputAction: 'עדכן פלט',

  // Clean 5D-R3 — guided empty/start state (State A). Additive only.
  // UX Compression Pass: subtitle/desc values below are UNCHANGED, but
  // StudioCanvas.js no longer renders them as always-visible text — they
  // are now used as hover tooltips (title attr) on the illustration and on
  // each choice card, per "move details into hover titles."
  hero: Object.freeze({
    eyebrow: 'סטודיו עיצוב',
    title: 'בואו נתחיל לעצב',
    subtitle: 'בחרו נקודת התחלה כדי לפתוח את הסטודיו',
    stonesTitle: 'צור תכשיט מאבנים',
    stonesDesc: 'בחרו אבנים מהמלאי כנקודת פתיחה לעיצוב',
    noStonesTitle: 'צור תכשיט ללא אבנים',
    noStonesDesc: 'התחילו מעיצוב מתכת בלבד, ללא אבן מרכזית',
    trayTitle: 'פתח מגש עבודה',
    trayDesc: 'המשיכו עבודה שכבר התחילה במגש',
  }),

  // Clean 5D-R3 — accessibility labels for icon-only / compact controls.
  aria: Object.freeze({
    addStones: 'הוסף אבנים למגש העבודה',
    exitStudio: 'חזרה למערכת',
    openSection: 'פתח סעיף',
    closeSection: 'סגור סעיף',
    workflowNav: 'שלבי עבודה בסטודיו',
  }),

  // Starter Asset Pack v1 — shown ONLY on a fallback demo/illustration image
  // (never on a real item photo), so it never reads as a final render.
  demoThumbBadge: 'אילוסטרציה',

  // Clean 5D-R4 — Studio Layout Reset. Additive only; no existing key above
  // was removed, renamed, or repurposed.
  stonePanelEmpty: 'בחרו אבן מהרצועה כדי לראות פרטים',
  addToTray: 'הוסף למגש העבודה',
  removeFromTray: 'הסר מהמגש',
  futureSoon: 'בקרוב',
  startDesign: 'התחל עיצוב',
  createReportSoon: 'צור תעודה — בקרוב',
  moreActionsSoon: 'פעולות נוספות — בקרוב',
  advancedStoneDetails: 'פרטים מתקדמים',
  toastAddedToTray: 'נוסף למגש העבודה',
  toastRemovedFromTray: 'הוסר מהמגש',

  // Patch B — Session Save / Project Birth. Additive only; no existing key
  // above was removed, renamed, or repurposed. The save action persists the
  // current design session as a Design Project (תיק עבודה) via the EXISTING
  // designProjects store — local only, no Airtable, no network.
  saveSession: 'שמור תיק עבודה',
  saveSessionAria: 'שמירת תיק העבודה הנוכחי',
  saveSessionEmptyHint: 'אין עדיין מה לשמור — הוסיפו אבנים או פרטי עיצוב',
  toastSessionSaved: 'תיק העבודה נשמר',
  toastSessionUpdated: 'תיק העבודה עודכן',
  defaultSessionTitlePrefix: 'תיק עבודה',
  defaultSessionTitleFallback: 'תיק עבודה חדש',
});

// ===========================================================================
// Patch D — Inventory / Tray / Studio Usability V1 (Hebrew, app-facing).
// Additive only: a NEW export. No existing exported object above was
// modified, renamed, or removed. Native Hebrew string literals (no \uXXXX).
// ===========================================================================
export const USABILITY_D_HE = Object.freeze({
  // Work Tray — inline inventory add (writes to the REAL Work Tray).
  addItems: 'הוסף פריטים',
  pickerTitle: 'הוספת פריטים מהמלאי',
  pickerSearch: 'חיפוש…',
  pickerEmpty: 'לא נמצאו פריטים',
  pickerAdd: 'הוסף',
  pickerRemove: 'הסר',
  pickerInTray: 'במגש ✓',
  pickerClose: 'סגירה',
  ...
  // Inventory catalog toolbar / cards / drawer.
  invTitle: 'מלאי אבנים',
  invItemsCount: (n) => `${n} פריטים`,
  invInTrayCount: (n) => `${n} במגש`,
  invFilters: 'סינון',
  invFilterType: 'סוג',
  invFilterSource: 'מקור',
  invFilterStatus: 'סטטוס',
  invAll: 'הכול',
  invInspect: 'פרטים',
  invClose: 'סגירה',
  invEdit: 'עריכת פרטים',
  invOpenTray: 'למגש העבודה',
  invOpenStudio: 'פתח סטודיו',
  invResetDemo: 'אפס דמו',
  invEmpty: 'אין פריטים תואמים',

  // Design Studio — multi-stone clarity.
  stonesCount: (n) => `${n} אבנים`,
  groupCenterPrefix: 'מרכזית',
  sessionDetailsTitle: 'פרטי עבודה',
  activeStoneLabel: 'אבן פעילה',
});

// ===========================================================================
// Clean 5E — Design Intent Layer (Hebrew, app-facing).
// Additive only: a NEW export. No existing exported object above was renamed
// or removed. Native Hebrew string literals (no \uXXXX). English render-brief
// wording lives in lib/studio/designOutputs.js, never here.
// ===========================================================================
export const INTENT_HE = Object.freeze({
  // Drawer / summary chrome.
  drawerTitle: 'כוונת עיצוב',
  openIntent: 'כוונת עיצוב',
  summaryEmpty: 'הגדר כוונת עיצוב',
  done: 'סיום',
  close: 'סגירה',
  notDecided: 'לא הוחלט',

  // Section labels (1–3 words, iceberg UX).
  jewelryTypeLabel: 'מה יוצרים?',
  styleLabel: 'סגנון',
  metalLabel: 'מתכת',
  stoneUsageLabel: 'שימוש באבנים',
  freedomLabel: 'רמת חופש',
  noteLabel: 'מה אתה רוצה ליצור?',
  notePlaceholder: 'לדוגמה: טבעת אירוסין עדינה סביב האמרלד, עם יהלומים קטנים בצדדים…',

  // Freedom level names (canonical value → Hebrew).
  ...
  // One-line meanings — shown small inside the picker only.
  freedomHint: Object.freeze({
    locked: 'צמוד לנתוני האבנים ולרפרנס, מינימום סטייה יצירתית',
    guided: 'שומר על הרעיון, מאפשר שיפורים מקצועיים (ברירת מחדל)',
    creative: 'פרשנות עיצובית חזקה, שיבוצים חלופיים ורעיונות חדשים',
    exploratory: 'השראה חופשית ברמת קולקציה — ריאליסטי ומודע לייצור',
  }),
});
...
// Additive only: a NEW export. No existing exported object above was renamed,
// removed, or edited. Native Hebrew string literals (no \uXXXX escapes).
// ===========================================================================
export const STUDIO_6A_HE = Object.freeze({
  // Guided-start hero — 4 primary actions (Clean 6A start panel).
  hero: Object.freeze({
    pickStonesTitle: 'בחר אבנים מהמלאי',
    pickStonesDesc: 'בחרו אבנים כנקודת פתיחה — בלי לצאת מהסטודיו',
    uploadTitle: 'העלה אבן / נכס',
    uploadDesc: 'העלו אבן, קובץ או נכס קיים לספרייה ולמגש העבודה',
    fromModelTitle: 'התחל מתכשיט / מודל קיים',
    fromModelDesc: 'בקרוב — התחלה מתכשיט או מודל קיים בספרייה',
    noStonesTitle: 'התחל ללא אבנים',
    noStonesDesc: 'עיצוב מתכת בלבד, ללא אבן מרכזית',
    soonBadge: 'בקרוב',
    resumeChip: 'המשך תיק עבודה',
  }),

  // Composition Board (לוח קומפוזיציה) — role-grouped multi-stone view.
  board: Object.freeze({
    openLabel: 'קומפוזיציה',
    title: 'לוח קומפוזיציה',
    subtitle: 'האבנים בעבודה הנוכחית, לפי תפקיד בעיצוב',
    stonesCount: (n) => (n === 1 ? 'אבן אחת בעבודה' : `${n} אבנים בעבודה`),
    editRole: 'ערוך תפקיד',
    closeEditRole: 'סגור עריכה',
    addStones: 'הוסף אבנים מהמלאי',
    empty: 'אין עדיין אבנים בעבודה הנוכחית',
    close: 'סגירה',
  }),

  // Derived concept sketches — honest schematic wording only.
  sketch: Object.freeze({
    paneTag: 'סקיצת קונספט',
    schematicNote: 'סקיצה סכמטית — לא הדמיה',
    thumbTitle: (name) => (name ? `סקיצה סכמטית — ${name}` : 'סקיצה סכמטית'),
  }),
});

// ===========================================================================
// Clean 6B — Studio Flow Clarity + Visible Design Directions.
// Additive only: a NEW export. Four existing label VALUES above were
// surgically corrected for terminology (directionTitle, styleDirectionLabel,
// notesPlaceholder, variantsTitle) — no key renamed, none removed.
// ===========================================================================
export const STUDIO_6B_HE = Object.freeze({
  // Always-visible calm escape navigation (command-bar breadcrumb).
  nav: Object.freeze({
    dashboard: 'לוח הבקרה',
    inventory: 'מלאי',
    tray: 'מגש עבודה',
    dashboardTitle: 'חזרה ללוח הבקרה',
    inventoryTitle: 'חזרה למלאי',
    trayTitle: 'חזרה למגש עבודה',
  }),

  // Design-direction actions (palette never traps the user).
  directions: Object.freeze({
    backToAll: 'חזרה לכיוונים',
    backToAllTitle: 'הצג את כל הכיוונים — הבחירה נשמרת',
    clearSelection: 'בטל בחירה',
    clearSelectionTitle: 'ביטול בחירת הכיוון הנוכחי',
    regenerate: 'צור כיוונים חדשים',
    regenerateTitle: 'מעבר ליצירת כיווני עיצוב חדשים',
    backToSelected: 'חזרה לכיוון הנבחר',
    paletteTitle: 'כיווני עיצוב',
  }),

  // Next-step guidance — one calm line, state → hint.
  next: Object.freeze({
    prefix: 'השלב הבא',
    noStones: 'בחרו אבנים או התחילו ללא אבנים',
    noIntent: 'הגדירו כוונת עיצוב',
    noDirections: 'צרו כיווני עיצוב',
    pickDirection: 'בחרו כיוון',
    haveSelected: 'הפיקו בריף הדמיה — או חזרו לכיוונים',
    staleDirections: 'הקלט השתנה — עדכנו את הכיוונים',
  }),
});
