...
// ===========================================================================
// Design Snapshot — Hebrew UI labels (Clean 3D)
// ===========================================================================
...
export const PROJECTS_HE = Object.freeze({
  ...
  // Item actions
  open: 'פתיחה בסטודיו',
  duplicate: 'שכפול כווריאציה',
  rename: 'שינוי שם',
  archive: 'העברה לארכיון',
  unarchive: 'שחזור מארכיון',
  markInReview: 'סימון לבדיקה',
  approve: 'אישור לשמירה',
  backToDraft: 'החזרה לטיוטה',
  duplicateForEdit: 'שכפול לשינוי',
  approvedLocked: 'מאושר — לשינויים יש לשכפל כווריאציה חדשה.',
  save: 'שמירה',
  cancel: 'ביטול',
