...
export const STUDIO_5D_HE = Object.freeze({
  ...
  stonesEmpty: 'עבודת מתכת בלבד — ללא אבנים',
  ...
  // Canvas
  canvasPickDirection: 'בחרו כיוון עיצוב',
  ...
  canvasStarterStones: 'האבנים שנבחרו מוכנות לעיצוב',
  canvasSlot: 'כיוון',

  // Inspector drawer
  inspectorTitle: 'מפרט הכיוון',
  inspectorEmpty: 'בחרו כיוון עיצוב כדי לראות את המפרט.',
  rows: Object.freeze({
    centerStone: 'אבן מרכזית',
  ...
  staleOutputTitle: 'הפלט מבוסס על כיוון קודם',
