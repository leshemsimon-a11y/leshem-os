...
export const CONCEPT_HE = Object.freeze({
  ...
  // Clean 6B.1 — terminology: this titles the INPUT form (the user's
  // request). User-facing language is 'תפריט עיצוב'; 'כיוון' is reserved
  // for generated design directions only.
  directionTitle: 'תפריט עיצוב',
...
export const STUDIO_5D_HE = Object.freeze({
  ...
  // Bottom strip
  variantsTitle: 'כיווני עיצוב', // Clean 6B.1 — the palette is explicitly the generated design directions
...
// Additive only: a NEW export. Two existing label VALUES above were
// surgically corrected (directionTitle, variantsTitle) — no key renamed,
// none removed. Native Hebrew string literals (no \uXXXX escapes).
// ===========================================================================
export const STUDIO_6B1_HE = Object.freeze({
  intentCard: Object.freeze({
    title: 'מה ניצור?',
    subtitle: 'בחר סוג תכשיט, סגנון, מתכת ורמת חופש פעולה',
    openMenu: 'פתח תפריט עיצוב',
    editMenu: 'ערוך תפריט עיצוב',
    edit: 'עריכה',
  }),
});

// ===========================================================================
// Clean 6C — Studio North Star Workstation. Additive only: a NEW export.
// No existing key or value touched. Native Hebrew literals.
// ===========================================================================
export const STUDIO_6C_HE = Object.freeze({
  // Docked design menu (desktop right panel).
  dock: Object.freeze({
    title: 'תפריט עיצוב',
    collapse: 'כווץ',
    expand: 'הרחב',
  }),
  // Process strip — derived status only, never navigation.
  process: Object.freeze({
    stones: 'אבנים',
    menu: 'תפריט עיצוב',
    directions: 'כיווני עיצוב',
    chosen: 'כיוון נבחר',
    brief: 'בריף',
    done: 'הושלם',
    active: 'פעיל',
    pending: 'ממתין',
    aria: 'מצב תהליך העיצוב',
  }),
  // Calm quick actions (studio orientation).
  actions: Object.freeze({
    title: 'פעולות מהירות',
    inventory: 'חזרה למלאי',
    tray: 'חזרה למגש עבודה',
    dashboard: 'חזרה ללוח הבקרה',
  }),
  // Directions strip.
  strip: Object.freeze({
    generateNew: 'צור כיוונים חדשים',
  }),
});
